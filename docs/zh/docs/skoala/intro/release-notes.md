...
- **新增** Nacos 创建/更新支持自定义注解
- **新增** Chart 升级自动更新 CRD 的功能
- **修复** 网关存在异常情况下的网关列表展示错误的问题
- **修复** 网关命名空间筛选异常的问题
- **修复** 安装器 plugin-server 镜像缺失的问题
- **修复** skoala-init 没有安装时 AI 网关创建接口返回成功的问题
